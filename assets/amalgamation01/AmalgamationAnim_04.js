...
lib.ssMetadata = [
		{name:"AmalgamationAnim_04_atlas_", frames: [[400,837,198,195],[200,837,198,196],[0,837,198,196],[0,0,1993,835]]}
];
...
(lib.FME01 = function() {
	this.initialize(ss["AmalgamationAnim_04_atlas_"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.AmalgamationAnim_04 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/AmalgamationAnim_04_atlas_.png", id:"AmalgamationAnim_04_atlas_"}
	],
	preloads: []
};
